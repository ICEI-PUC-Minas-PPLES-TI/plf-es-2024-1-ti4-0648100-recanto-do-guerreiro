...
async function displayWorkshops() {
    ...
    try {
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square icon-margin" viewBox="0 0 16 16">
          ...
          <br>
          <button class = "btn btn-excluir" "icon-margin-Dele "onclick="deletereserva(${workshop.id})"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill icon-margin" viewBox="0 0 16 16">
